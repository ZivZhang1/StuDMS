...
public class loginService
{
	...
	public String check(String sushehao)
	{		
		String result="no";
		String sql="from TStu where stuZhengzhimianmao=?";
		Object[] con={sushehao};
		List stuList=stuDAO.getHibernateTemplate().find(sql,con);
		if(stuList.size()<=5)
		{
			 result= Integer.toString(stuList.size()); 
		}
		else
		{
			 result="no";
	...
	public String login(String userName,String userPw,int userType)
	{
		...
		if(userType==2)//学生登陆
		{
			...
			System.out.println("\nbookCase*********************action="+userName);			
			System.out.println("\nbookCase*********************action="+userType);			
